...
namespace QLHotel
{
    public partial class CheckOut_QL : Form
    {
        public CheckOut_QL()
        {
            InitializeComponent();
        ...
        private void CheckOut_QL_Load(object sender, EventArgs e)
        {
            ...
            com.CommandText = "SELECT ho,ten FROM quanly WHERE quanly_id=@id";
