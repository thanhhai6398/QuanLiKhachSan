...
namespace QLHotel
{
    public partial class CheckOut_LC : Form
    {
        MY_DB db = new MY_DB();
        ...
        private void CheckOut_LC_Load(object sender, EventArgs e)
        {
            ...
            com.CommandText = "SELECT ho,ten FROM laocong WHERE laocong_id=@id";
